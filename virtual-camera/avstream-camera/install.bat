@echo off
REM Virtual Camera Driver Installation Script

echo ========================================
echo Virtual Camera Driver Installation
echo ========================================
echo.
...
pnputil /delete-driver vcam.inf /uninstall /force >nul 2>&1

REM Add the driver package
pnputil /add-driver "%~dp0inf\vcam.inf" /install
if %errorLevel% neq 0 (
...
REM devcon install "%~dp0inf\vcam.inf" Root\VirtualCamera
...
echo.
echo After restart, the Virtual Camera should appear
echo in your device manager under "Cameras" category.
echo.
pause
